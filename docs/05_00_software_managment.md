...
[![conda_logo](https://upload.wikimedia.org/wikipedia/commons/e/ea/Conda_logo.svg){: width="160" }](https://docs.conda.io/projects/conda/en/latest/index.html)
...
[![mamba_logo](https://mamba.readthedocs.io/en/latest/_static/logo.png){: width="160" }](https://mamba.readthedocs.io/en/latest/index.html#)
...
[![docker_logo](https://upload.wikimedia.org/wikipedia/commons/1/1e/Docker_Logo.png){: width="160" }](https://www.docker.com/)
...
[![apptainer_logo](https://apptainer.org/apptainer.svg){: width="160" }](https://apptainer.org/)
...
[![snakemake_logo](https://upload.wikimedia.org/wikipedia/commons/c/c7/Snakemake_logo_dark.png){: width="160" }](https://snakemake.readthedocs.io/en/)
...
[![nextflow_logo](https://upload.wikimedia.org/wikipedia/commons/e/e1/Logo_Nextflow_%28new%29.png){: width="160" }](https://www.nextflow.io/)
